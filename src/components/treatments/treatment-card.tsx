...
/** One treatment as a tappable card. Used flat and inside groups. */
export function TreatmentCard({ t }: { t: TreatmentListItem }) {
  return (
    <Link
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <StatusPill status={t.status} needsConfirmation={t.needsConfirmation} />
      </div>
